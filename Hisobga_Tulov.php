...
class PaymeController extends Controller{
    ...
    public function index(Request $request){
                ...
                $response = [
                    'error' => [
                        ...
                        'message'=>[
                            ...
                            'ru' => 'Сумма платежа указана неверно.',
                            'en' => 'The payment amount is incorrect.',
                        ]
                    ]
                ];
                return $response;
                    ...
                    $response = [
                        'error' => [
                            ...
                            'message'=>[
                                ...
                                'ru'=>'Эту операцию невозможно выполнить.',
        ...
        if($request->method == 'PerformTransaction'){
            ...
            ### To'lov amalga oshirilgandan so'ng bajariladigan amallar ###
                ...
                $response = [
                    'error'=>[
                        ...
                        'message'=>[
                            ...
                            'ru'=>'Отправлено в неправильном формате.',
                            'en'=>'Sent in wrong format.',
                        ]
                    ]
                ];
                return $response;
